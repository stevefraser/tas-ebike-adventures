                                    ...
                                    $images = get_sub_field('photo_gallery');
                                      if($images) {
                                        foreach( $images as $image ) {
                                            echo '<a style="background-color: #d3d3d3; background-image: url(' . $image["url"] . '); background-size: cover; background-repeat: no-repeat; background-position: center center;" class="image_gallery ' . $cols . '" rel="image_gal" title="' . $image["caption"] . '" href="' . $image["url"] . '">';
                                            echo '</a>';
                                        }
                                      }
