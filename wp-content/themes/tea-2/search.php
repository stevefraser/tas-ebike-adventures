...
<section class="section-hero">
      ...
      <?php
          ...
          echo '<div class="fullwidth hero" style="background: url(' . get_bloginfo("template_directory") . '/img/backgrounds/bg_scenery_1.jpg); background-size: cover; background-position: center center; height: 45%; height: 55vh;">';
                ?>
                <div class="container">
                  <div class="row">
